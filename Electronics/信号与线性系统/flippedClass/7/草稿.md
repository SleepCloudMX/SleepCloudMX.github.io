...
```mathematica
(* 该表格的代码是官网提供的样例 *)
flist = {{UnitStep[n], n, z}, {E^(-\[Alpha] n), n, 
    z}, {Sin[\[Alpha] n], n, z}, {n^3 + 3 n + 1, n, z}, {n^k, n, 
    z}, {ChebyshevU[n, x], n, z}, {a^n Cos[Pi n], n, 
    z}, {(m + 1) (n - m), {m, n}, {u, v}}, {a^n m^3, {m, n}, {u, v}}};
Grid[Join[{{f, Text["Z-Transform"]}}, 
   Transpose[{flist[[;; , 1]], Map[ZTransform @@ # &, flist]}]], 
...
```mathematica
(* 求解 z 变换及其收敛域 *)
ZTransform[3^-n UnitStep[n], n, z, GenerateConditions -> True]
(* 绘制收敛域的图像 *)
...
<img src="image/3.2.1.png" alt="image-20230602173229113" style="zoom:50%;" />
...
<img src="image/3.2.2.png" alt="image-20230602174055758" style="zoom:50%;" />
...
<img src="image/3.2.3.png" alt="image-20230602174308438" style="zoom:50%;" />
