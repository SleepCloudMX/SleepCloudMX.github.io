...
一方面，$ \curl \bm B = \mu \curl \bm H = \mu \bm J + \mu \d\pdv{\bm D}{t} = \mu \bm J + \mu \ve \pdv{\bm E}{t} = \mu \bm J - \mu \ve \pdv{t} \pqty{\grad \phi + \pdv{\bm A}{t}} $，

另一方面，$ \curl \bm B = \curl (\curl \bm A) = \grad(\div \bm A) - \Delta \bm A $，

于是 $ \Delta \bm A - \mu \ve \d\pdv[2]{\bm A}{t} = -\mu \bm J + \grad \pqty{\div \bm A + \mu \ve \pdv{\varphi}{t}} $，
