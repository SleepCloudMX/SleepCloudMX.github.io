...
- RC 低通滤波器
  ...
  - $ v_\o = -i_\rm{AV} T = -\dfrac{g_\rm m R V_\rm{cm}}{\pi} \pqty{1 + m_\rm a \cos\Omega t} $.
- 特点
  - 电容器的输出电压没有反馈回输入.
  - be 结在正半周导通，负半周截止.
...
- 负峰切割失真
  - 产生原因
    ...
    - 交直流幅度之比变为 $ \dfrac{I_\rm{AV\sim}}{I_\rm{AV=}} = \dfrac{R}{R \parallel R_\rm L} m_\rm a = \dfrac{R + R_\rm L}{R_\rm L} m_\rm a $.
