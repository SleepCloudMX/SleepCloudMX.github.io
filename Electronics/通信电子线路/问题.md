...
- [ ] 第二章
  - [x] 具体来说，什么是功率谱密度？
    ...
    答：某一段频率的值可对应到时域中的分量，于是求其功率即可.
  
  - [x] 噪声电流均方值 $ \overline{I_\text n^2} $ 为什么不除以带宽？这样和 $ P_\text I $ 有什么区别？
  
    答：没有区别，二者定义完全相同.
    
  - [x] 为什么  $ k T_0 = -174\ \rm{dBm / Hz} $？
  
    我的天，我在这里卡了好久（而且好困），原来是 mathematica 默认以 e 为底数...
