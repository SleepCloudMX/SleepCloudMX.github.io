...
<img src="image\1.2.png" width=450>
...
<img src="image\1.4.png" width=450>
...
<img src="image\1.6.5E.png" width=450>
...
<img src="image\1.7.7E.png" width=450>
...
<img src="image\2.10.png" width=450>
...
## 3.4	Circle through Point Tangent to Line :star:
...
已知一点 $A$, 一条直线 $l$ 及其上一点 $B$, 求过 $A$ 作圆且与直线相切于点 $B$.
...
<center class="half">
    ...
    <img src="image\3.6.proof3.png" width=450>
</center>
...
<img src="image\3.7.2L.png" width=450>
...
<img src="image\3.8.5L.png" width=450>
...
<img src="image\3.8.7E.png" width=450>
...
<img src="image\3.9.png" width=450>
...
如图, $ E, F, H, I, J, K $ 分别为 $ AB, CD, BC, AD, AC, BD $ 的中点.
...
## 4.2	Angle of $60^\circ$ - 2 :star::star:
...
<img src="image\4.3.6E.png" width=450>
...
<img src="image\4.4.5L.png" width=450>
...
1. 以给定圆上一点 $B$ 为圆心, $BA$ 为半径作圆, 交给定圆于点 $A$ 与 $C$;
...
Let |AB|=1. Construct a point C on the ray AB such that the length of AC is equal to √2.
...
<img src="image\4.7.png" width=450>
...
<img src="image\4.8.5E.png" width=450>
...
<img src="image\4.9.10E.png" width=450>
...
<img src="image\4.10.10E.png" width=450>
...
<img src="image\4.11.7E.png" width=450>
...
<img src="image\5.9.6L.png" width=450>

**7E**

<img src="image\5.9.7E.png" width=450>
...
<img src="image\6.1.4L.png" width=450>
...
<img src="image\6.5.5E.png" width=450>
...
<img src="image\6.6.proof.png" width=450>
...
<img src="image\7.3.3L.png" width=400>
...
<img src="image\7.4.png" width=400>
...
<img src="image\7.7.8E.png" width=500>
...
<img src="image\8.1.7E.png" width=450>
...
<img src="image\8.2.5E.png" width=400>

**证明**	同 8.2.4L method 2.
...
<img src="image\8.4.9L.png" width=450>

**13E** :crescent_moon:

<img src="image\8.4.13E.png" width=350>
...
<img src="image\8.5.3L.png" width=400>
...
<img src="image\8.5.7E.png" width=450>
...
<img src="image\8.7.png" width=400>
...
<img src="image\8.8.7L.png" width=400>

**8E**

<img src="image\8.8.8E.png" width=450>
...
<img src="image\8.9.5L.png" width=400>

**7E** :crescent_moon:

<img src="image\8.9.7E.png" width=450>
...
Construct a chord of the given circle that is parallel to the given segment and congruent to it.
...
## 9.3	Harmonic mean of Trapezoid Bases :crescent_moon:
...
Construct the midpoint of the segment using only a straightedge. To help you, a line parallel to the segment is given.
...
<img src="E:\Notes\Math\几何\Euclidea\image\9.9.5L.png" width=400>
...
Construct an inner tangent between two circles.
...
## 10.5	Rotation of $60^\circ$ :crescent_moon:
...
<img src="E:/Notes/Math/几何/Euclidea/image/11.2.5E.png" width=450>
...
## 11.4	Angle of $54^\circ$ :crescent_moon:
...
**注**	根据点 $A$, $B$, $l_1$ 和交点 $H$ 的相对位置, 有如下等价情况
...
令 $ BC = h,\, CG = d,\, CD = R_1,\, CE = R_2,\, GF = R_3 $, 则
...
<img src="E:/Notes/Math/几何/Euclidea/image/11.7.6L.png" width=450>
...
则五边形 $AHJIG$ 即为所求作正五边形. 作完.

<img src="E:/Notes/Math/几何/Euclidea/image/11.8.10E.png" width=450>

**证明**

令 $AO = 1$, 则由 11.3.5E 知: $ OE = \dfrac{\sqrt5-1}{2} $, $ BG = \dfrac{\sqrt5+1}{2} $, $ \angle{GAB} = \arcsin\dfrac{BG}{BA} = 54^\circ $, $ \angle{BGF} = \dfrac{1}{2}\angle{ABG} = 18^\circ $, $ \angle{AGI} = \angle{AGB} + \angle{BGI} = 108^\circ $,

故五边形 $AHJIG$ 即为所求作正五边形. 证毕.

---

## 11.9	Point Farthest from Angle Sides

Construct a point of the circle such that the sum of distances from it to the sides of the angle is the maximum possible.

已知圆 $O$ 和圆外两条直线 $l_1$ 和 $l_2$ 交于点 $A$, 求作圆上一点 $B$, 使之与两直线距离之和最大.

**2L**

<img src="E:/Notes/Math/几何/Euclidea/image/11.9.2L.png" width=450>

**注**	设两直线夹角为 $ \alpha \in (0, \pi) $, $OB$ 与 $l_1$ 夹角为 $\theta$, 点 $O$ 到 $l_1$ 和 $l_2$ 的距离分别为 $d_1$ 和 $d_2$, 则 $B$ 与两直线的距离之和为
$$
d_1 + d_2 + \sin\theta + \sin\pqty{\alpha - \theta} = d_1 + d_2 +2\sin\dfrac{\alpha}{2}\cos\pqty{\theta-\dfrac{\alpha}{2}}.
$$
...
<img src="E:/Notes/Math/几何/Euclidea/image/11.9.4E.png" width=450>

**注**	直接作出中垂线 (角平分线) 的平行线.

## 11.10	Ratio $1$ to $5$ :crescent_moon:

Construct a point on the line segment that divides it in the ratio 1 : 5.
...
1. 作 $AB$ 的中垂线 $m$, 交 $AB$ 于点 $C$;
2. 以 $C$ 为圆心, $AB$ 为半径作圆, 交 $m$ 于点 $D$ 与 $E$;
3. 连接 $EA$, 交圆 $C$ 于点 $F$;
4. 作 $\angle{BDF}$ 的角平分线, 交 $AB$ 于点 $G$, 交 $EF$ 于点 $H$.

则 $G$ 即为所求点. 作完.

<img src="E:/Notes/Math/几何/Euclidea/image/11.10.4L.png" width=400>

**证明**

$ AE \parallel BD $, $ \angle{DFE} = 90^\circ $, $ \angle{FHD} = \angle{HDB} = \angle{HDF} = 45^\circ $,

令 $AB=1$, 则 $ AE = DB = \dfrac{\sqrt5}{2} $, $ FH = DF = \dfrac{2\sqrt5}{5} $, $ EF = \dfrac{4\sqrt5}{5} $,

$ AH = FH + AE - EF = \dfrac{\sqrt5}{10} $, 故 $ AG : GB = AH : DB = 1:5 $.
...
2. 作圆 $AB$, 交 $AB$ 于点 $C$;
3. 作圆 $BC$, 交 $AB$ 于点 $D$;
4. 作圆 $DA$, 交圆 $AB$ 于点 $E$ 与 $F$;
5. 连接 $EF$, 交 $AB$ 于点 $G$.

则 $G$ 即为所求点. 作完.

<img src="E:/Notes/Math/几何/Euclidea/image/11.10.5E.png" width=450>

**证明**

连接 $AE$, 作 $ DH \perp AE $ 交 $AE$ 于点 $H$,

则 $ \triangle{AEG} \backsim \triangle{AHD} $, 故 $ \dfrac{AB}{AG} = \dfrac{2AH}{AG} = \dfrac{2AD}{AE} = 6 $.
...
## 12.1	Triangle by Midpoints :star:

Construct a triangle given the midpoints of its sides.

求作一三角形, 已知其三边中点 $A$, $B$, $C$.

**5L**

<img src="E:/Notes/Math/几何/Euclidea/image/12.1.5L.png" width=400>
...
则 $ \triangle{GHI} $ 即为所求作三角形. 作完.

<img src="E:/Notes/Math/几何/Euclidea/image/12.1.8E.png" width=400>

**证明**

前四步: $ AB \parallel CF,\, \angle{BCF} = \angle{AFC} $ (全等可证).

后四步: $ \angle{AGF} = \angle{AFG} = \angle{BCF} $, 故 $ AG \parallel BC $, 四边形 $ ABCG $ 是平行四边形, $ HA = AG = BC $, $ \triangle{GHI} $ 即为所求作三角形. 证毕.

---

## 12.2	Triangle by Side and Centroid

Construct a triangle with the given side and centroid.

**6L**

<img src="E:/Notes/Math/几何/Euclidea/image/12.2.6L.png" width=400>

**注**	顶点到重心距离的一半 $=$ 重心到对边中点的距离.

---

**7E**

<img src="E:/Notes/Math/几何/Euclidea/image/12.2.7E.png" width=400>

**注**	直接在顶点到重心延长线上作中点.

## 12.3	Triangle by Altitude Base Points :star:

Construct an acute triangle whose altitude base points are given.

**5L**

<img src="E:/Notes/Math/几何/Euclidea/image/12.3.5L.png" width=400>

**注**	三角形垂心是垂直三角形的内心. (四点共圆可证.)
...
4. 作圆 $CB$, 交圆 $AB$ 于点 $D$;
5. 连接 $DC$, 交圆 $CB$ 于点 $E$;
6. 连接 $EB$, 依次交圆 $BC$, 圆 $BA$, 圆 $BC$ 于点 $F$, $G$, $H$;
7. 连接 $HC$;
8. 连接 $CF$;
9. 连接 $GA$, 交 $HC$ 于点 $I$, 交 $CF$ 于点 $J$;
10. 连接 $IB$, 交 $CF$ 于点 $K$.

则 $ \triangle{IJK} $ 记为所求作三角形. 作完.

<img src="E:/Notes/Math/几何/Euclidea/image/12.3.10E.png" width=500>

**证明**

$ CA \perp DB,\, DB \perp BE $, 故 $ AC \parallel BE,\, \angle{ACH} = \angle{CHB} = \angle{HCB} $, 故 $CH$ 即为垂足 $C$ 对应的高线.

$ \angle{HCF} = 90^\circ $, 故 $JK$ 即为所求三角形一边.

$ \angle{JAC} = \angle{JGF} = \angle{BAG} $, 故 $GJ$ 即为所求三角形一边.

故 $ \triangle{IJK} $ 记为所求作三角形. 证毕.

---

## 12.4	Triangle by Tangent Points

Construct a triangle with the three given points where its incircle touches its sides.

**6L**

<img src="E:/Notes/Math/几何/Euclidea/image/12.4.6L.png" width=400>

**10E** :star:

<img src="E:/Notes/Math/几何/Euclidea/image/12.4.10E.png" width=400>

**作法**	见 10.11.13E.

**证明**	见 10.11.13E.

## 12.5	Triangle by Excenters

Construct a triangle with the given excenters.

**9L 11E** :star:

<img src="E:/Notes/Math/几何/Euclidea/image/12.5.png" width=500>

**注**	一个三角形的内心即旁心三角形的垂心, 且这个三角形是其旁心三角形的垂足三角形, 并且内接三角形中周长最小的三角形即垂足三角形 (施瓦茨问题). 见命题 9.7.

## 12.6	Equilateral Triangle by Centroid and Two Points :crescent_moon:

Construct three lines that form an equilateral triangle with the centroid in the point O so that two of them contain one of the two given points each.

以已知点 $O$ 为中心, 作等边三角形经过点 $A$ 与 $B$.
...
则 $ \triangle{EFG} $ 即为所求作三角形. 作完.

<img src="E:/Notes/Math/几何/Euclidea/image/12.6.png" width=450>

**证明**

点 $A$ 绕点 $O$ 逆时针旋转 $120^\circ$ 即点 $D$, 且 $ \angle{AED} = \dfrac{1}{2}\angle{ACD} = 60^\circ $.

故 $ \triangle{EFG} $ 即为所求作三角形. 证毕.

**注**	顺时针旋转 $120^\circ$ 即为另一解.

## 12.7	Right Triangle by Two Points on Legs

Inscribe a right triangle into the circle so that the two given points lie on its two legs respectively. The center of the circle is in the point O.

**6L 8E**

<img src="E:/Notes/Math/几何/Euclidea/image/12.7.png" width=400>

## 12.8	Hypotenuse and Altitude :crescent_moon:

Given hypotenuse AB, construct a right triangle whose altitude drawn to AB is equal to the given segment.

求以线段 $AB$ 为斜边, $d$ 为 $AB$ 边上的高, 作一直角三角形.

**6L**

<img src="E:/Notes/Math/几何/Euclidea/image/12.8.6L.png" width=400>

**13E** :crescent_moon:

1. 作圆 $AB$;

2. 作圆 $BA$, 交圆 $AB$ 于点 $C$, $D$;

3. 连接 $CD$, 交 $AB$ 于点 $E$;

4. 以 $E$ 为圆心, $h$ 为半径作圆, 交 $CD$ 于点 $F$ 与 $G$; (5E)

5. 作圆 $FG$, 交 $CD$ 于点 $H$;

6. 作圆 $HF$, 交圆 $FG$ 于点 $I$ 与 $J$;

7. 连接 $IJ$, 交圆 $BA$ 于点 $K$, 交圆 $AB$ 于点 $L$,

   其中 $L$ 在线段 $IJ$ 上, $K$ 在线段 $IJ$ 的延长线上;

8. 连接 $AK$;

9. 连接 $BL$, 交 $AK$ 于点 $M$.

则 $ \triangle{ABM} $ 即为所求三角形. 作完.

<img src="E:/Notes/Math/几何/Euclidea/image/12.8.13E.png" width=450>

**证明**

$ LK \parallel AB $, 四边形 $ ABKL $ 是菱形 (可以使用锐角三角形中的 "$ASS$" 证明) , 故 $ AM \perp BM $, 且 $ \triangle{ABM} $ 在 $AB$ 边上的高为菱形高的一半, 即 $h$. 故 $ \triangle{ABM} $ 即为所求三角形. 证毕.

## 12.9	Hypotenuse and Leg :crescent_moon:

Construct a right triangle with the given hypotenuse AB and whose leg is equal to the given segment.

**5L**

<img src="E:/Notes/Math/几何/Euclidea/image/12.9.5L.png" width=400>
...
则 $ \triangle{ABI} $ 即为所求三角形. 作完.

<img src="E:/Notes/Math/几何/Euclidea/image/12.9.9E.png" width=450>

**证明**

$CD$ 是 $ \triangle{BFE} $ 的中位线, $ BG = FB = 2 CD $, 且 $AH$ 垂直平分 $BG$.

故 $ \triangle{ABI} $ 即为所求三角形. 证毕.

## 12.10	Isosceles Triangle by Tangent Points :star:

Construct an isosceles triangle that is circumscribed about the circle and contains the given points.

求作圆 $O$ 的外切三角形, 使之切于已知点 $A$ 与 $B$.

**5L**

<img src="E:/Notes/Math/几何/Euclidea/image/12.10.5L.png" width=400>
...
2. 作圆 $BA$, 交圆 $OB$ 于点 $D$;
3. 作圆 $AD$, 交圆 $BA$ 于点 $E$;
4. 作圆 $OE$, 交圆 $AB$ 于点 $F$ 与 $G$;
5. 连接 $BF$;
6. 连接 $GC$, 交 $BF$ 于点 $H$;
7. 连接 $AE$. 交 $CG$ 于点 $I$, 交 $BF$ 于点 $J$.

则 $ \triangle{HIJ} $ 即为所求三角形. 作完.

<img src="E:/Notes/Math/几何/Euclidea/image/12.10.7E.png" width=450>

**证明**

由命题 2.8 知: $ OA \perp AE $.

$ AF = AB = BE,\, AO = BO,\, FO = EO $, 故 $ \triangle{AOF} \cong \triangle{BOE} $.

$ \angle{AOE} = \angle{AOF} - \angle{EOE} = \angle{BOF} - \angle{EOF} = \angle{BOF},\, AO = BO,\, EO = FO $, 故 $ \triangle{AOE} \cong \triangle{BOF} $.

故 $ \angle{OBF} = \angle{OAE} = 90^\circ $, 同理 $ OC \perp HI $.

故 $ \triangle{HIJ} $ 即为所求三角形. 证毕.
...
## 13.1	Circle Tangent to Line and Circle

Construct a circle tangent to the line at the given point and to the given circle.

求作圆与直线 $l$ 切于点 $A$, 且与圆 $O$ 相切.

### 4L

<img src="E:/Notes/Math/几何/Euclidea/image/13.1.4L.png" width=400>

**注**	已知焦点, 作出抛物线的准线.

---

### 8E :star::crescent_moon:

**作法**

1. 过点 $A$ 作 $ m \perp l $;
2. 在直线 $m$ 上取一点 $B$, 作圆 $BA$, 使之与圆 $O$ 有两个交点 $C$ 与 $D$;
3. 连接 $CD$, 交 $l$ 于点 $E$;
4. 作圆 $EA$, 交圆 $O$ 于点 $F$;
5. 连接 $OF$, 交 $m$ 于点 $G$;
6. 作圆 $GA$.
...
**注**	根据点 $F$ 的位置, 有内切与外切两个解.

<img src="E:/Notes/Math/几何/Euclidea/image/13.1.8E.png" width=400>

**证明**

$ \angle{EAD} = 90^\circ - \angle{DAB} = \dfrac{1}{2}\angle{ADB} = \angle{ECA} $, $ \angle{DEA} = \angle{AEC} $,

故 $ \triangle{EAD} \backsim \triangle{ECA} $, $ EF^2 = EA^2 = ED \cdot EC $, 故 $ EF \perp OF $ (圆幂定理逆定理).

故 $ \triangle{EFG} \cong \triangle{EAG}\;(HL) $, $ FG = AG $.

故圆 $GA$ 即为所求圆. 证毕.

**注**	实际上根轴 $CD$ 上任意一点到圆 $O$ 与圆 $BA$ 的切线长相等. 第一步相似的条件即弦切角定理.

**注**	由外切圆的唯一性知 $AE$ 长为定值.

## 13.2	Equilateral Triangle - 2

Construct an equilateral triangle whose one vertex is given and two others lie on the two parallel lines.

给定一点 $A$, 求作等边三角形 $ABC$, 且另外两个端点在已知两直线 $l_1$ 和 $l_2$ 上.

### 13.2.1	引理

> 已知点 $D$ 在以等边三角形 $ABC$ 的边 $AC$ 为直径的圆上, 且为 $AE$ 中点, 则 $ \angle{BEA} = 30^\circ $.

<img src="E:/Notes/Math/几何/Euclidea/image/13.2.7.lemma.png" width=250>

**证明**

$CD$ 垂直平分 $AE$, 故 $ABCE$ 四点共圆, 故 $ \angle{BEA} = \dfrac{1}{2}\angle{BCA} = 30^\circ $.

---

### 7L :star::crescent_moon:

**作法**

1. 作 $ AB \perp l_1 $, 交 $l_1$ 于点 $B$, 交 $l_2$ 于点 $C$;
2. 作圆 $BA$, 交 $AB$ 于点 $D$;
3. 作圆 $AB$, 交圆 $BA$ 于一点 $E$;
4. 连接 $EC$, 交圆 $BA$ 于点 $F$;
5. 连接 $AF$, 交 $l_2$ 于点 $G$;
6. 作 $ AH \perp AE $, 交 $l_1$ 于点 $H$;
7. 连接 $GH$.

则 $ \triangle{AGH} $ 即为所求三角形. 作完.

<img src="E:/Notes/Math/几何/Euclidea/image/13.2.7L.png" width=400>

**证明**

$ \angle{AFE} = \dfrac{1}{2}\angle{ABE} = 30^\circ $, $ \angle{HAG} = 90^\circ - \angle{AFE} = 60^\circ $,

$ \angle{GCD} = \angle{GFD} = 90^\circ $, 故 $CDFG$ 四点共圆, $ \angle{GDC} = \angle{GFC} = 30^\circ $.

又 $ Ab = BD $, 由反证法知以 $AG$ 为边的等边三角形若另一点 $H'$ 与 $D$ 在 $AG$ 同侧, 则 $H'$ 在 $l_1$ 上, 故 $ \triangle{AGH} $ 即为所求三角形. 证毕.

**注**	设圆 $AB$ 与圆 $BA$ 交于另一点 $I$, 则 $IGD$ 三点共线, 因为 $ \angle{IDA} = \angle{GDA} = 30^\circ $.
...
> 若 $ \angle{BAC} = 60^\circ $, $ \angle{BEA} = 30^\circ $, $CD$ 垂直平分 $AE$, 则 $ \triangle{ABC} $ 是等边三角形.
...
则 $ \triangle{AFG} $ 即为所求三角形. 作完.

<img src="E:/Notes/Math/几何/Euclidea/image/13.2.8E.png" width=450>

**证明**

$A$ 与 $D$ 关于 $l_1$ 对称, $ \angle{FDA} = \dfrac{1}{2}\angle{EBA} = 30^\circ $, $ AF = AC $,

故 $ \triangle{AFG} $ 即为所求三角形. 证毕.

**注**	类似 13.2.7L 有如下逆定理

### 13.2.3	逆定理 2

> 若 $AB=BC$, $ \angle{BEA} = 30^\circ $, $CD$ 垂直平分 $AE$, 则 $ \triangle{ABC} $ 是等边三角形.

<img src="E:/Notes/Math/几何/Euclidea/image/13.2.7.lemma.png" width=250>

## 13.3	Equilateral Triangle On Concentric circles

Construct an equilateral triangle with the given vertex so that the other vertices lie on the given concentric circles respectively.

求作等边三角形, 使其一定点为已知点 $A$, 另外两个点在以 $O$ 为圆心的同心圆 $O_1$ 和 $O_2$ 上, 其中圆 $O_2$ 的半径更大.

**注**	如果至少有一解, 则有且仅有四解.

---

### 6L :star::crescent_moon:

**作法**

1. 以 $A$ 为圆心, 圆 $O_1$ 半径为半径作圆, 交圆 $O_2$ 于点 $B$;
2. 作 $OB$ 的中垂线 $m$, 交 $O_2$ 于一点 $C$;
3. 作圆 $AC$, 交圆 $O_1$ 于一点 $D$, 且 $D$ 与 $C$ 在 $AO$ 两侧;
4. 连接 $AC$;
5. 连接 $CD$;
6. 连接 $DA$.

则 $ \triangle{ACD} $ 即为所求三角形. 作完.

**注**	若点 $C$ 取圆 $AB$ 与圆 $O_2$ 的另一交点, 则为第二解. 关于 $AO$ 对称又有两解.

<img src="E:/Notes/Math/几何/Euclidea/image/13.3.6L.png" width=500>

**证明**

作圆 $CA$, 交圆 $O_1$ 于一点 $D'$, 使 $A$ 与 $D$ 在 $CO$ 同侧.

则 $ \triangle{COD'} \cong \triangle{CBA}\; (SSS) $, $ \angle{ACD} = \angle{ACB} + \angle{BCD} = \angle{OCD} + \angle{BCD} = 60^\circ $.

故 $ \triangle{ACD'} $ 是等边三角形, $D$ 与 $D'$ 重合, $ \angle{ACD} $ 也是等边三角形. 证毕.

---

### 13.3.1	引理

> 已知圆 $O$ 和圆外一点 $A$, 作圆 $AO$ 交圆 $O$ 于一点 $B$, 作圆 $OA$, 交圆 $AO$ 于一点 $C$, 作圆 $BA$ 交圆 $AB$ 于点 $D$, 且 $C$ 与 $D$ 在 $AB$ 同侧, 则 $ CD = OB $.

<img src="E:/Notes/Math/几何/Euclidea/image/13.3.1.lemma.png" width=450>

**证明**

$ \triangle{ABD} $ 和 $ \triangle{AOC} $ 是等边三角形, $ \angle{BAO} = \angle{BAD} - \angle{OAD} = \angle{OAC} - \angle{OAD} = \angle{DAC} $,

故 $ \triangle{BAO} \cong \triangle{DAC}\; (SAS) $, $ BO = DC $. 证毕.
...
则 $ \triangle{AEF} $ 即为所求三角形. 作完.

<img src="E:/Notes/Math/几何/Euclidea/image/13.3.8E.png" width=500>

**证明**

由 13.3.1 知: $ CE = CD = OB = OF $, 故 $ \triangle{AEC} \cong \triangle{AFO}\; (SSS) $,

故 $ \angle{FAE} = \angle{FAO} + \angle{OAE} = \angle{EAC} + \angle{OAE} = \angle{OAC} = 60^\circ $.

故 $ \triangle{AEF} $ 即为所求三角形. 证毕.

## 13.4	Square in Triangle

Inscribe a square in the acute triangle ABC so that one of its sides lies on AC.

求作 $ \triangle{ABC} $ 的 $AC$ 边上的内接正方形.

**注**	可以任作 $AC$ 边上的接于 $AB$ 边的一个正方形, 再由位似作出所求正方形, 但这样需要 12L 16E.
...
1. 作圆 $AC$;
2. 作 $ AD \perp AC $, 交圆 $AC$ 于点 $D$;
3. 连接 $BD$, 交 $AC$ 于点 $E$;
4. 作 $ EF \perp AC $, 交 $AB$ 于点 $F$;
5. 作 $ FG \parallel AC $, 交 $BC$ 于点 $G$;
6. 作 $ GH \perp AC $, 交 $AC$ 于点 $H$.

则四边形 $EFGH$ 即为所求正方形. 作完.

<img src="E:/Notes/Math/几何/Euclidea/image/13.4.6L.png" width=400>

**证明**

作 $ BI \perp AC $, 交 $AC$ 于点 $I$, 则

$ \dfrac{FG}{AC} = \dfrac{FB}{AB} = \dfrac{EI}{AI} = \dfrac{EI}{AE} \cdot \dfrac{AE}{AI} = \dfrac{BI}{AD} \cdot \dfrac{EF}{BI} = \dfrac{EF}{AC} $,

故矩形四边形 $EFGH$ 即为所求正方形. 证毕.

---

### 12E

<img src="E:/Notes/Math/几何/Euclidea/image/13.4.12E.png" width=400>

**注**	与 13.4.6L 几乎完全相同.

## 13.5	Point Equidistant from Side of Angle and Point

Given an angle ABC and a point M inside it, find points D on BA and E on BC and construct segments MD and DE of equal length so that DE is perpendicular to BC.

### 5L :crescent_moon:

<img src="E:\Notes\Math\几何\Euclidea\image\13.5.5L.png" width=400>

**注**	见 11.6.6L.

**注**	根据第二圆与 $BC$ 的交点位置, 最多有两解.

---

### 8E :crescent_moon:

<img src="E:\Notes\Math\几何\Euclidea\image\13.5.8E.png" width=400>

**注**	见 11.6.11E.

## 13.6	Circle Through Two Points and Tangent to Line

Construct a circle that goes through the two given points and that is tangent to the given line.

### 6L :crescent_moon:

<img src="E:\Notes\Math\几何\Euclidea\image\13.6.6L.png" width=400>

**注**	见 11.6.6L 或 13.5.5L.

**注**	此即阿波罗尼斯第二问题 ($LPP$), 最多有两解.

---

### 10E :crescent_moon:

<img src="E:\Notes\Math\几何\Euclidea\image\13.6.10E.png" width=400>

**注**	见 11.6.11E 或 13.5.8E.

## 13.7	Inscribed Square - 2

Inscribe a square in the circle. A point on a side of the square is given.

已知圆 $O$ 和圆内一点 $A$, 求过点 $A$ 作圆的内接正方形.

**注**	有对称的两解.

### 13.7.1	引理

> 已知: 在 $\triangle{ABC}$ 中, $AB=AC$, $CG$ 是 $AB$ 边上的高线, $ BF \perp AC $, 且以 $AC$ 为直径的圆交 $BF$ 于点 $D$ 与 $F$ ($BDF$ 三点的顺序任意). 点 $M$ 是 $AC$ 的中点, 点 $E$ 在 $CG$ 上, 且 $GE=EF$.
>
> 求证: $ \triangle{AGD} \backsim \triangle{MEC} $.

<img src="E:\Notes\Math\几何\Euclidea\image\13.7.1.lemma.png" width=400>

**证明**

$ \angle{AGC} = \angle{ADC} = 90^\circ $, 故 $AGDCE$ 五点共圆, $ \angle{GDA} = \angle{GCA} $.

故 $ \triangle{GME} \cong \triangle{FME}\; (SSS) $, 且 $ME$ 垂直平分 $GF$.

$MG=CM$, $ \triangle{MCE} = \angle{MGE} = \angle{MFE} $, 故 $MFCE$ 四点共圆.
$$
\begin{align}
\angle{GFE} &= \angle{FGE} = \angle{FAC} = \angle{DAC} = \angle{DFC}
\\
\angle{GAD} &= \angle{GFD} = \angle{GFE} - \angle{DFE}
\\
&= \angle{DFC} - \angle{DFE} = \angle{EFC} = \angle{EMC}
\end{align}
$$
已经证明 $ \angle{GDA} = \angle{GCA} $, 故 $ \triangle{AGD} \backsim \triangle{MEC} $. 证毕.

---

**注 1**	或者设 $ DF \cap ME = H $, 则 $ \angle{GAD} = \angle{GFD} = 90^\circ - \angle{MHF} = \angle{EMC} $.

---

**注 2**	下证 $ \triangle{AGF} \backsim \triangle{MEF} $, 即 $ \triangle{AGF} \backsim \triangle{MEG} $.

$ \angle{AFG} = \angle{ACG} = \angle{MGC} $, 又 $ DC = CF $, 故
$$
\begin{align}
\angle{AGF} &= 90^\circ - \angle{FGC} = 90^\circ - \angle{DGC} = \angle{BGD}
\\
&= 180^\circ - \angle{AGD} = 180^\circ - \angle{MEC} = \angle{MEG}
\end{align}
$$
故 $ \triangle{AGF} \backsim \triangle{MEG} $. 证毕.
...
1. 作圆 $AO$, 交圆 $O$ 于点 $B$ 与 $C$;
2. 连接 $BA$, 交圆 $O$ 于点 $D$;
3. 作 $ DE \perp AB $, 交圆 $AO$ 于点 $E$;
4. 作 $CE$ 的中垂线, 交圆 $O$ 于点 $F$ 与 $G$;
5. 作 $ HG \perp FG $, 交圆 $O$ 于点 $H$;
6. 作 $ HI \perp HG $, 交圆 $O$ 于点 $I$;
7. 连接 $IF$.

则四边形 $FGHI$ 即为所求正方形. 作完.

<img src="E:\Notes\Math\几何\Euclidea\image\13.7.7L.png" width=500>
...
延长 $ED$, 交圆 $AO$ 于点 $K$, 交圆 $O$ 于点 $L$.

连接 $JO$, $JC$, $LO$, $LC$, $OB$, $BK$, $KJ$, $OA$.

连接 $BC$, 交 $FG$ 于点 $M$, 连接 $OM$.

作 $ AN \perp OB $, 交 $OB$ 于点 $N$.
...
$ BD \perp DE $, 故 $BL$ 是直径, 即 $LOB$ 三点共线.

$ \angle{LCB} = \angle{JCB} = 90^\circ $, 故 $JCL$ 三点共线.

$ JO \perp OB $, 故 $ \triangle{JLB} $ 是等腰三角形.

$OBEC$ 四点共圆, $AONM$ 四点共圆.

$AO$ 是 $ \triangle{JLB} $ 其中位线, 且 $ \triangle{OAB} $ 是等腰三角形.

---

**注 1**	注意到 $BC$, $DL$, $JO$ 三线交于点 $G_0$, 点 $C$ 是 $BG_0$ 与 $JL$ 的交点, 且 $ CD \parallel LB $, 我们可以以此仅用无刻度直尺过圆上一点作直径的平行线.

---

3. $ \triangle{CJK} \backsim \triangle{MAB} $. (见 13.7.1 引理)

**注 2**	还有 $BMAE$ 四点共圆, 且 $ \triangle{CJE} \backsim \triangle{MAC} $, 不过这里我们用不到.

---

4. $ \triangle{AOM} \backsim \triangle{JKB} $.

$$
\begin{align}
\angle{OAM} &= \angle{OAB} - \angle{MAB}
\\
&= \angle{LJB} - \angle{CJK} = \angle{KLB},
\\
\angle{MOB} &= \angle{MAN} = \angle{NAB} - \angle{MAB}
\\
&= \angle{CJO} - \angle{CJK} = \angle{KJO} = \angle{KBO},
\\
\angle{AOM} &= \angle{AON} - \angle{MON}
\\
&= \angle{ABN} - \angle{KBO} = \angle{JBK},
\end{align}
$$

故$ \triangle{AOM} \backsim \triangle{JKB} $.
...
$ \angle{OMA} = \angle{BKJ} = 90^\circ $, 故
$$
OM^2 = PM \cdot MQ = CM \cdot MB = FM \cdot MG,
$$
故 $ OF \perp OG $. 故四边形 $FGHI$ 即为所求正方形. 证毕.

---

**注 5**	对 $OM$ 所在三角形使用射影定理及其逆定理; 在圆 $A$ 和圆 $O$ 中分别对弦 $BC$ 使用圆幂定理.
...
1. 作圆 $OA$;
2. 连接 $AO$, 交圆 $OA$ 于点 $B$;
3. 作圆 $AO$, 交圆 $OA$ 于点 $C$ 与 $D$;
4. 连接 $CD$, 交 $AO$ 于点 $E$;
5. 作圆 $EO$, 交 $CD$ 于点 $F$;
6. 作圆 $FO$, 交已知圆 $O$ 于点 $G$, 交圆 $OA$ 于点 $H$;
7. 连接 $GA$, 交圆 $O$ 于点 $I$;
8. 连接 $GH$, 交圆 $O$ 于点 $J$;
9. 连接 $JB$, 交圆 $O$ 于点 $K$;
10. 连接 $KI$.

则四边形 $GIKJ$ 即为所求正方形. 作完.

<img src="E:\Notes\Math\几何\Euclidea\image\13.7.10E.png" width=450>

**证明**

设 $AG$ 交圆 $EO$ 于点 $L$, 如图连线, 则

$ OL \perp AL $, $ OF \perp AF $, $ \angle{OGL} = \dfrac{1}{2}\angle{OFA} = 45^\circ $, 故 $IG$ 即为所求一边.

$AFH$ 三点共线, 故 $ \angle{AGH} = 90^\circ $, 故 $GJ$ 为所求正方形另一边.

$A$ 和 $B$ 关于正方形中心 $O$ 对称, 故四边形 $GIKJ$ 即为所求正方形. 证毕.

## 13.8	Line Reflection

Reflect the straight line OA with respect to any of axes using only a straightedge. The axes intersect at right angle.

### 5L 5E :crescent_moon:

<img src="E:\Notes\Math\几何\Euclidea\image\13.8.png" width=450>

**证明**

注意到三角形的垂心即垂足三角形的内心, 仿射即证.

## 13.9	Square by Four Points

Construct a line through each of the given points so that all the four lines form a square in intersection. The points A and B should lie on parallel lines.

已知 $ABCD$ 四点, 且作正方形, 使得 $ABCD$ 分别在正方形各边的直线上, 且 $A$ 与 $B$ 在对边.
...
1. 连接 $CD$;
2. 以 $A$ 为圆心, $CD$ 为半径作圆;
3. 作 $ AE \perp CD $, 交圆 $A$ 于点 $E$;
4. 连接 $BE$;
5. 作 $ CF \perp BE $, 交 $BE$ 于点 $F$;
6. 作 $ DG \perp BE $, 交 $BE$ 于点 $G$;
7. 作 $ AH \perp DG $, 交 $DG$ 于点 $H$, 交 $CF$ 于点 $I$.

则四边形 $FGHI$ 即为所求正方形. 作完.

<img src="E:\Notes\Math\几何\Euclidea\image\13.9.7L.png" width=350>

**证明**

由作图过程知: 四边形 $FGHI$ 是矩形.

作 $ CJ \perp GH $, 交 $GH$ 于点 $J$, 作 $ EK \perp AI $, 交 $AI$ 于点 $K$,

则 $ \triangle{AEK} \cong \triangle{DCJ}\; (ASA) $, $ GH = EK = JC = HI $,

故四边形 $FGHI$ 即为所求正方形. 证毕.

---

### 13.9.1	引理

> 若四边形 $ABCD$ 是正方形, $E$ 在直线 $AB$ 上, $F$ 在直线 $CD$ 上, $ \triangle{EGF} $ 是以 $EF$ 为为斜边的等腰直角三角形, 且 $G$ 与 $B$ 在 $EF$ 两侧, 则 $DGB$ 三点共线.

<img src="E:\Notes\Math\几何\Euclidea\image\13.9.1.lemma.png" width=300>

**证明**

$BEGF$ 四点共圆, 故 $ \angle{EBG} = \angle{EFG} = \angle{EBD} $, 故 $DGB$ 三点共线. 证毕.
...
1. 连接 $AC$;
2. 作 $AC$ 的中垂线 $m_1$, 交 $AC$ 于点 $E$; (3E)
3. 作圆 $EA$, 交 $m_1$ 于点 $F$;
4. 连接 $BD$;
5. 作 $BD$ 的中垂线 $m_2$, 交 $BD$ 于点 $G$; (3E)
6. 作圆 $GB$, 交 $m_2$ 于点 $H$;
7. 连接 $FH$, 交圆 $EA$ 于点 $I$, 交圆 $GB$ 于点 $J$;
8. 连接 $AI$;
9. 连接 $JB$;
10. 连接 $IC$, 交 $JB$ 于点 $K$;
11. 连接 $JD$, 交 $AI$ 于点 $L$.

则四边形 $IJKL$ 即为所求正方形. 作完.

<img src="E:\Notes\Math\几何\Euclidea\image\13.9.15E.png" width=350>

**证明**

由 13.9.1 知: $FH$ 即为所求正方形对角线.

$ \angle{KJI} = \dfrac{1}{2}\angle{BGH} = 45^\circ $, 同理 $ \angle{KIJ} = \angle{LJI} = \angle{LIJ} = 45^\circ $.

故四边形 $IJKL$ 即为所求正方形. 证毕.

---



## 13.10	Billiards on Round Table

Given a circle with center in O and points A and B on the same diameter. Construct a point C on the circe such that OC bisects the angle ACB.

### 9L

<img src="E:\Notes\Math\几何\Euclidea\image\13.10.9L.png" width=400>

**注**	$ABHG$ 成调和点列, 故圆 $HO$ 为点 $A$ 与 $B$ 关于点 $O$ 的阿波罗尼斯圆, 与已知圆的交点即为所求点.
...
<img src="E:\Notes\Math\几何\Euclidea\image\13.10.5L.png" width=300>

**证明**

$ \angle{DEF} = \dfrac{1}{2}\pqty{180^\circ - \angle{EOF}} = \dfrac{1}{2}(180^\circ - \angle{GOD}) = \angle{OGD} $, 故 $DEFG$ 四点共圆.

故 $ OA \cdot OB = OE \cdot OD = OF \cdot OG $, 故 $AFBG$ 四点共圆.

故 $ \angle{AGF} = \angle{ABF} = \angle{BAF} = \angle{BGF} $. 证毕.

---

**注**	关键点是注意到 $ \angle{AGO} = \angle{BGO} $ 等价于 $AFBG$ 四点共圆.

---

### 13.10.1	引理

> 已知圆 $A$ 上一点 $B$, 过 $B$ 作半径小于 $AB$ 的圆, 交圆 $A$ 于点 $C$ 与 $D$. 连接 $AB$, 交圆 $B$ 于点 $E$ 与 $F$, 其中 $E$ 在线段 $AB$ 上. 连接 $CE$, 交圆 $A$ 于点 $G$, 连接 $GD$, 交圆 $B$ 于点 $H$, 连接 $FH$. 则
>
> 1. $ AG \parallel BD \parallel FH $.
> 2. $ GE = GD $.
> 3. $ DE = DH $.

<img src="E:\Notes\Math\几何\Euclidea\image\13.10.1.lemma.png" width=450>

**证明**

$ \angle{GAD} = 2\angle{GCD} = \angle{EBD} = \angle{ADB} $, 故 $ AG \parallel BD $.

$ \angle{BDH} = \angle{BCG} = \angle{CEB} = \angle{AEG} $, 故 $ GE = GD $, $BG$ 垂直平分 $ED$.

$ \angle{BDH} = \angle{CEB} = \angle{BED} $, 故 $ DE = DH $.

$ \angle{AFH} = 2\angle{ECD} = \angle{EBD} $, 故 $ BD \parallel FH $. 证毕.
...
1. 连接 $AB$;
2. 作圆 $OB$, 交 $AB$ 于点 $C$;
3. 作圆 $AO$, 交圆 $OB$ 于点 $D$ 与 $E$;
4. 连接 $DC$, 交圆 $AO$ 于点 $F$;
5. 连接 $FE$, 交 $AB$ 于点 $G$;
6. 作圆 $GO$, 交 $AB$ 于点 $H$, 交已知圆 $O$ 于点 $I$ 与 $J$.

则点 $I$ 与 $J$ 即为所求点. 作完.

<img src="E:\Notes\Math\几何\Euclidea\image\13.10.6E.png" width=500>

**证明**

由 13.10.1 引理知: $ FO \parallel EO $, 故 $ \dfrac{OA}{OB} = \dfrac{AF}{OE} = \dfrac{AG}{OG} $.

由阿波罗尼斯圆定理知: 若 $ \dfrac{OA}{OB} = \dfrac{HA}{HB} $, 则点 $I$ 与 $J$ 即为所求点.

设 $OG=R$, 则
$$
\begin{align}
& \dfrac{OA}{OB} = \dfrac{HA}{HB} \\
\Leftarrow\quad & \dfrac{GA}{GO} = \dfrac{HA}{HB} \\
\Leftarrow\quad & \dfrac{OA+R}{R} = \dfrac{2R+OA}{2R-OB} \\
\Leftarrow\quad &\, OA \cdot OG = OB \cdot (OA+R) = OB \cdot AG
\end{align}
$$
而这正是引理的推论. 故点 $I$ 与 $J$ 即为所求点. 证毕.
...
## 14.1	Rhombus in Triangle

Inscribe a rhombus in the triangle so that they share the common angle A.

### 3L

<img src="E:\Notes\Math\几何\Euclidea\image\14.1.3L.png" width=400>

### 8E :star:

求作 $ \triangle{ABC} $ 的内接菱形, 且共用 $ \angle{A} $.
...
<img src="E:\Notes\Math\几何\Euclidea\image\14.1.8E.png" width=500>

**证明**

$ \angle{FBD} = 180^\circ - 2\angle{BDF} = 180^\circ - 2\angle{EDC} = \angle{DCE} $, 故 $ BF \parallel EC $.

$ \angle{BAF} = \angle{BFA} = \angle{FAC} $, 故 $AF$ 平分 $ \angle{BAC} $.

$ \angle{GHD} = \angle{GDH} = \angle{CDE} = \angle{DEC} $, 故 $ IH \parallel AC $.

$ \angle{GJD} = \angle{GDJ} = \angle{BAJ} $, 故 $ AB \parallel KG $.

故四边形 $AIGK$ 即为所求菱形. 证毕.

## 14.2	Circle Tangent to Two Circles

Construct a circle that is tangent to the two given circles and touches one of them in the given point.

求作一圆与已知圆 $A$ 和圆 $B$ 相切, 且切于圆 $A$ 上一已知点 $C$.
...
1. 连接 $AC$;
2. 以 $C$ 为圆心, 圆 $B$ 半径为半径作圆, 交 $AC$ 于一点 $D$;
3. 作 $BD$ 的中垂线, 交 $AC$ 于点 $E$;
4. 作圆 $EC$.
...
**注**	取圆 $C$ 与 $AC$ 的另一交点为 $D$, 则有另一解.

<img src="E:\Notes\Math\几何\Euclidea\image\14.2.4L.png" width=350>

**证明**

$ EA - EB = EA - ED = DA = CA - CD = CA - R_B $, 故圆 $EC$ 即为所求圆. 证毕.
...
<img src="E:\Notes\Math\几何\Euclidea\image\14.2.7E.png" width=450>

**证明**

$ \angle{BFD} = \angle{BDF} = \angle{AED} $, 故 $ BF \parallel AE $.

$ \angle{HCG} = \angle{BFG} = \angle{BGF} = \angle{HGC} $, 故 $ HC = HG $. 证毕.

## 14.3	Triangle by Tangent Point of Hypotenuse

Construct a right triangle with the given hypotenuse and the tangent point of its incircle.

求作以已知线段 $AB$ 为斜边的直角三角形, 且内切圆交 $AB$ 于一已知点 $C$.

### 6L :crescent_moon:

**作法**

1. 作 $AB$ 的中垂线 $m$, 交 $AB$ 于点 $O$;
2. 作圆 $OA$, 交 $m$ 于点 $D$;
3. 作 $OD$ 的中垂线, 交 $OD$ 于点 $E$;
4. 作圆 $EC$, 交圆 $OA$ 于点 $F$;
5. 连接 $AF$;
6. 连接 $BF$.

则 $ \triangle{ABF} $ 即为所求作三角形. 作完.

<img src="E:\Notes\Math\几何\Euclidea\image\14.3.6L.png" width=450>

**证明**

设 $FC$ 中点为 $J$, 则即证 $ CF \perp EJ $.

以 $O$ 为原点, $OA$ 为 $x$ 轴, $OD$ 为 $y$ 轴建系,

设 $ OA=1, AF = a, BF = b $, 则内切圆半径为 $ r = \dfrac{a+b-2}{2} $. 故
$$
\begin{array}{ll}
	&C = \pqty{\dfrac{a-b}{2}, 0},\,
	F = \pqty{\dfrac{a^2}{2}-1, \dfrac{ab}{2}},
	&J = \pqty{\dfrac{a^2-a+b-2}{2}, \dfrac{ab}{2}},
	\\
	&\vector{EJ} = \pqty{\dfrac{a^2+a-b-2}{4}, \dfrac{ab-2}{4}},
	&\vector{CF} = \pqty{\dfrac{a^2-a+b-2}{2}, \dfrac{ab}{2}},
	\\
\end{array}
$$
...
$$
\begin{align}
	8\vector{EJ} \cdot \vector{CF}
	&= (a^2-2)^2 - (a-b)^2 + a^2b^2 - 2ab
	\\
	&= a^4 - 4a^2 + 4 - a^2 - b^2 + 2ab + a^2b^2 - 2ab
	\\
	&= 0
\end{align}
$$

故 $ CE \perp EJ $, $ \triangle{ABF} $ 即为所求三角形. 证毕.
...
1. 作 $AB$ 的中垂线 $m$, 交 $AB$ 于点 $O$; (3E)
2. 作圆 $OC$, 交 $m$ 于点 $D$, 交 $AB$ 于点 $E$;
3. 作圆 $OA$;
4. 连接 $DE$, 交圆 $OA$ 于点 $F$;
5. 作圆 $FA$, 交圆 $OA$ 于点 $G$;
6. 连接 $AG$;
...
则 $ \triangle{ABG} $ 即为所求三角形. 作完.

<img src="E:\Notes\Math\几何\Euclidea\image\14.3.9E.png" width=450>

## 14.4	Parallelogram on Four Lines

Construct a parallelogram whose center is in the given point so that each of the given lines contains one of its vertices. Two of the lines are parallel.

已知 $ AB \parallel CD,\, AD \cap BC = E $, 求作顶点分别在这四条直线上的平行四边形, 且其中心为已知点 $P$.

### 8L :crescent_moon:

**作法**

1. 作 $ PF \parallel AB $, 交 $AD$ 于点 $F$, 交 $BC$ 于点 $G$;
2. 作圆 $FD$, 交 $AD$ 于点 $H$;
3. 作圆 $GB$, 交 $BC$ 于点 $I$;
4. 连接 $IP$, 交 $AB$ 于点 $J$;
5. 连接 $HI$;
6. 连接 $HJ$;
7. 作 $ JK \parallel HI $, 交 $CD$ 于点 $K$;
8. 连接 $KI$.

则四边形 $ HJKI $ 即为所求四边形. 作完.

**注**	若在第 3 和 4 步作圆 $FA$ 和圆 $GC$, 则有另一解.

<img src="E:\Notes\Math\几何\Euclidea\image\14.4.8L.png" width=450>

**证明**

$ \dfrac{IP}{PJ} = \dfrac{IG}{GB} = 1 \RA IP = PJ, $

连接 $HP$, 交 $CD$ 于点 $K'$, 同理 $ HP = PK' $,

则四边形 $ HJK'I $ 是平行四边形, $ K = K' $,

故四边形 $ HJKI $ 即为所求四边形. 证毕.

---

### 12E

<img src="E:\Notes\Math\几何\Euclidea\image\14.4.12E.png" width=450>

## 14.5	Arbelos

Construct a circle tangent to the three given pairwise tangent circles whose centers are collinear.

已知 $ O, A, B $ 三点共线, 且圆 $ O, A, B $ 两两相切如图. 求作一圆与此三圆两两相切.

### 5L 7E :star:

**作法**

1. 作 $CE$ 的中垂线, 交圆 $O$ 于点 $F$. (3E)
2. 作圆 $FC$, 交圆 $A$ 于点 $G$, 交圆 $B$ 于点 $H$;
3. 连接 $AG$;
4. 连接 $BH$, 交 $AG$ 于点 $I$;
5. 作圆 $IG$.
...
<img src="E:/Notes/Math/几何/Euclidea/image/14.5.png" width=450>

**证明**

如图作辅助线, 则 $ \angle{ACF} = \angle{CFO} = 45^\circ $,

$ \angle{AGF} = \angle{CGF} - \angle{CGA} = \angle{GCF} - \angle{GCA} = \angle{ACF} = 45^\circ $,

故 $ \angle{IGF} = 135^\circ $, 同理 $ \angle{IHF} = 135^\circ $.

又 $ GF = HF,\, IF = IF,\, \angle{GIF} = 45^\circ - \angle{GFI} < 90^\circ,\, \angle{HIF} < 90^\circ $,

故 $ \triangle{GIF} \cong \triangle{HIF},\, IG = IH $.

设 $ AD = r_1,\, BD = r_2,\, IG = r_3 $, 则 $ OC = AB = r_1 + r_2,\, OA = r_2,\, OB = r_1 $,

设 $ OI = d,\, DI = b $, 则只需证 $ d = r_1 + r_2 - r $.

在 $ \triangle{IAO}, \triangle{IDB}, \triangle{AIB} $ 中分别使用斯特瓦尔特定理, 解得 $ r = \dfrac{r_1r_2 (r_1+r_2)}{r_1^2 + r_2^2 + r_1r_2} $, $ d = r_1 + r_2 - r $,
